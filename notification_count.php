...
$c_msg_res = $con->query("SELECT COUNT(*) FROM tbl_messages WHERE receiver_id = '$user_id' AND chat_platform = 'community' AND seen = 0");
$c_msg = ($c_msg_res) ? $c_msg_res->fetch_row()[0] : 0;

// Count everything (Messages + Proposals + Follows)
$q = $con->query("
    SELECT (
