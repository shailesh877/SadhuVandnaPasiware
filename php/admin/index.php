...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <a href="admin_new_registration.php" class="block bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 group border-t-4 border-orange-500">
    ...
    <!-- Card 2: All Members -->
    <a href="admin_all_community_member.php" class="block bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 group border-t-4 border-green-500">
      <div class="flex items-center justify-between mb-4">
    ...
    <a href="admin_block_user.php" class="block bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 group border-t-4 border-red-500">
      <div class="flex items-center justify-between mb-4">
    ...
    <a href="admin_wallet.php" class="block bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 group border-t-4 border-blue-500">
      <div class="flex items-center justify-between mb-4">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <a href="create_temple.php" class="block bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 group hover:scale-105">
      <div class="flex items-center justify-between mb-4">
    ...
    <a href="create_branch.php" class="block bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 group hover:scale-105">
      <div class="flex items-center justify-between mb-4">
        <div class="w-14 h-14 rounded-lg bg-white/10 bg-opacity-20 backdrop-blur flex items-center justify-center">
    ...
    <a href="add_views_news.php" class="block bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 group hover:scale-105">
      <div class="flex items-center justify-between mb-4">
        <div class="w-14 h-14 rounded-lg bg-white/10 bg-opacity-20 backdrop-blur flex items-center justify-center">
    ...
    <a href="admin_jobs_education.php" class="block bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 group hover:scale-105">
      <div class="flex items-center justify-between mb-4">
        <div class="w-14 h-14 rounded-lg bg-white/10 bg-opacity-20 backdrop-blur flex items-center justify-center">
