...
if(isset($_POST["submit_data"])){
    ...
    $sql = "INSERT INTO tbl_jobs_education (type, title, description, created_at)
            VALUES ('$type', '$title', '$description', '$date')";

   if(mysqli_query($con, $sql)){
    $message = "Data Added Successfully!";
    echo "<script>
        window.location='admin_jobs_education.php?msg=" . urlencode($message) . "&type=success';
    </script>";
} else {
    $message = "Error!";
    echo "<script>
        window.location='admin_jobs_education.php?msg=" . urlencode($message) . "&type=error';
    </script>";
}
