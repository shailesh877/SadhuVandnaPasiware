...
<b>Height:</b> <?= $m['height'] ?: 'N/A'; ?><br>
<b>Weight:</b> <?= $m['weight'] ?: 'N/A'; ?><br>
<b>Education:</b> <?= $m['education'] ?: 'N/A'; ?><br>
<b>Occupation:</b> <?= $m['occupation'] ?: 'N/A'; ?><br>
<b>Income:</b> <?= $m['income'] ?: 'N/A'; ?><br>
<b>Marital Status:</b> <?= $m['marital_status']; ?><br>
<b>Caste / Samaj:</b> <?= $m['caste'] ?: 'N/A'; ?><br>
<b>Kuldevi:</b> <?= $m['kuldevi'] ?: 'N/A'; ?>
...
<script>
document.getElementById("toggleMemberForm").onclick=()=>{
