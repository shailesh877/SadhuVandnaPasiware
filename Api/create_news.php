...
$stmt = $con->prepare("INSERT INTO tbl_news (user_id, title, description, image, category, created_at) VALUES (?, ?, ?, ?, ?, ?)");
$stmt->bind_param("isssss", $user_id, $title, $description, $mediaString, $category, $date);
